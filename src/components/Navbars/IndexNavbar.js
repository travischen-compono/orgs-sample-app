        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            >
              <img
                style={{ height: "40px" }}
                src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.appengine.ai%2Fcompany%2Fcompono&psig=AOvVaw1YvcOsjCOhbN9a_UKtXtIM&ust=1628729685709000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCLCf84Xhp_ICFQAAAAAdAAAAABAJ"
              />
              Compono
            </Link>
            <button
